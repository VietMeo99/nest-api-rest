...
const analytics = class_transformer_1.plainToClass(analytics_entity_1.Analytics, analytics_json_1.default);
const categoryWiseProduct = class_transformer_1.plainToClass(category_wise_product_entity_1.CategoryWiseProduct, category_wise_product_json_1.default);
const lowStockProducts = class_transformer_1.plainToClass(product_entity_1.Product, low_stock_products_json_1.default);
const topRateProduct = class_transformer_1.plainToClass(top_rate_product_entity_1.TopRateProduct, top_rate_product_json_1.default);
