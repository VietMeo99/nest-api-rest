...
const tags = class_transformer_1.plainToClass(tag_entity_1.Tag, tags_json_1.default);
const options = {
    keys: ['name'],
    threshold: 0.3,
};
...
let TagsService = class TagsService {
    ...
    findAll({ page, limit, search }) {
        ...
        return Object.assign({ data }, paginate_1.paginate(this.tags.length, page, limit, this.tags.length, url));
    }
