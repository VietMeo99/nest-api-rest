...
const shops = class_transformer_1.plainToClass(shop_entity_1.Shop, shops_json_1.default);
const nearShops = class_transformer_1.plainToClass(shop_entity_1.Shop, near_shop_json_1.default);
const options = {
...
let ShopsService = class ShopsService {
    ...
    getStaffs({ shop_id, limit, page }) {
        ...
        return Object.assign({ data: results }, paginate_1.paginate(staffs === null || staffs === void 0 ? void 0 : staffs.length, page, limit, results === null || results === void 0 ? void 0 : results.length, url));
    }
    getShop(slug) {
