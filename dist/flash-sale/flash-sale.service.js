...
const flashSale = class_transformer_1.plainToClass(flash_sale_entity_1.FlashSale, flash_sale_json_1.default);
const options = {
    keys: ['title'],
    threshold: 0.3,
};
const fuse = new fuse_js_1.default(flashSale, options);
const productsByFlashSale = class_transformer_1.plainToClass(product_entity_1.Product, products_by_flash_sale_json_1.default);
...
let FlashSaleService = class FlashSaleService {
    ...
    findAllProductsByFlashSale({ search, limit, page }) {
        ...
        return Object.assign({ data: results }, paginate_1.paginate(productsByData.length, page, limit, results.length, url));
    }
};
