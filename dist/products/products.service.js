...
const products = class_transformer_1.plainToClass(product_entity_1.Product, products_json_1.default);
const popularProducts = class_transformer_1.plainToClass(product_entity_1.Product, popular_products_json_1.default);
const bestSellingProducts = class_transformer_1.plainToClass(product_entity_1.Product, best_selling_products_json_1.default);
const options = {
    keys: [
        'name',
        'type.slug',
