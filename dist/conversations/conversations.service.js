...
const conversations = class_transformer_1.plainToClass(conversation_entity_1.Conversation, conversations_json_1.default);
const options = {
    keys: ['shop.name'],
    threshold: 0.3,
};
...
let ConversationsService = class ConversationsService {
    ...
    getAllConversations({ page, limit, search }) {
        ...
        return Object.assign({ data }, paginate_1.paginate(this.conversations.length, page, limit, this.conversations.length, url));
    }
