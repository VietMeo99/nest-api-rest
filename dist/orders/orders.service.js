...
const orders = class_transformer_1.plainToClass(order_entity_1.Order, orders_json_1.default);
const paymentIntents = class_transformer_1.plainToClass(payment_intent_entity_1.PaymentIntent, payment_intent_json_1.default);
const paymentGateways = class_transformer_1.plainToClass(payment_gateway_entity_1.PaymentGateWay, payment_gateway_json_1.default);
const orderStatus = class_transformer_1.plainToClass(order_status_entity_1.OrderStatus, order_statuses_json_1.default);
const options = {
    keys: ['name'],
    threshold: 0.3,
};
const fuse = new fuse_js_1.default(orderStatus, options);
const orderFiles = class_transformer_1.plainToClass(order_entity_1.OrderFiles, order_files_json_1.default);
const settings = class_transformer_1.plainToClass(setting_entity_1.Setting, settings_json_1.default);
let OrdersService = class OrdersService {
    ...
    async getOrders({ limit, page, customer_id, tracking_number, search, shop_id, }) {
        ...
        return Object.assign({ data: results }, paginate_1.paginate(data.length, page, limit, results.length, url));
    }
    ...
    async getOrderFileItems({ page, limit }) {
        ...
        return Object.assign({ data: results }, paginate_1.paginate(orderFiles.length, page, limit, results.length, url));
    }
