...
__decorate([
    common_1.Get('tracking-number/:tracking_id'),
    openapi.ApiResponse({ status: 200, type: require("./entities/order.entity").Order }),
    __param(0, common_1.Param('tracking_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __param(0, common_1.Param('param')),
    __param(1, common_1.Query('language')),
    __metadata("design:type", Function),
...
OrderStatusController = __decorate([
    common_1.Controller('order-status'),
    __metadata("design:paramtypes", [orders_service_1.OrdersService])
...
__decorate([
    common_1.Post('digital_file'),
    openapi.ApiResponse({ status: 201, type: String }),
    __param(0, common_1.Body('digital_file_id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
