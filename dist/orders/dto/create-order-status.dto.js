...
class CreateOrderStatusDto extends swagger_1.PickType(order_status_entity_1.OrderStatus, [
    'name',
    'color',
    'serial',
    'language',
...
class UpdateOrderStatusDto extends swagger_1.PartialType(CreateOrderStatusDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return {};
    }
}
