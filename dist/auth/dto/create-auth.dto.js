...
class RegisterDto extends swagger_1.PickType(user_entity_1.User, ['name', 'email', 'password']) {
    constructor() {
        super(...arguments);
...
class LoginDto extends swagger_1.PartialType(swagger_1.PickType(user_entity_1.User, ['email', 'password'])) {
    static _OPENAPI_METADATA_FACTORY() {
        return {};
    }
}
