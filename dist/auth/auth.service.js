...
const users = class_transformer_1.plainToClass(user_entity_1.User, users_json_1.default);
let AuthService = class AuthService {
    constructor() {
        this.users = users;
    }
    async register(createUserInput) {
        const user = Object.assign(Object.assign(Object.assign({ id: uuid_1.v4() }, users[0]), createUserInput), { created_at: new Date(), updated_at: new Date() });
