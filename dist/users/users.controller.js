...
AdminController = __decorate([
    common_1.Controller('admin/list'),
    __metadata("design:paramtypes", [users_service_1.UsersService])
], AdminController);
...
VendorController = __decorate([
    common_1.Controller('vendors/list'),
    __metadata("design:paramtypes", [users_service_1.UsersService])
], VendorController);
...
AllStaffsController = __decorate([
    common_1.Controller('all-staffs'),
    __metadata("design:paramtypes", [users_service_1.UsersService])
], AllStaffsController);
...
AllCustomerController = __decorate([
    common_1.Controller('customers/list'),
    __metadata("design:paramtypes", [users_service_1.UsersService])
